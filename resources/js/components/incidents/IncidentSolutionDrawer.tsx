            ...
            <div className="mx-auto w-full max-w-2xl">
                <DrawerHeader>
                    ...
                    <DrawerDescription>
                        {hasSteps 
                            ? 'Procedimiento detallado para resolver el incidente'
                            : 'Genera una solución automática para este incidente'
                        }
                    </DrawerDescription>
                </DrawerHeader>
                    ...
                    <div className="bg-accent/50 rounded-lg p-4">
                        {hasSteps ? (
                                ...
                                {(steps ?? '').split('\n').map((step, index) => {
                                    ...
                                    return (
                                        <div key={index} className="flex items-start gap-2">
                                            <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-primary text-primary-foreground text-xs font-medium flex-shrink-0 mt-0.5">
                                                {index + 1}
                                            </span>
                            ...
                            <div className="text-center py-8 text-muted-foreground">
                                ...
                                <p className="text-xs mt-1">Haz clic en "Generar" para crear una solución automática</p>
                            </div>
                        )}
                    </div>
                </div>
